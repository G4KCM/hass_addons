...
class Comfort2(mqtt.Client):
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        self.publish("homeassistant/alarm_control_panel/"+DOMAIN+"/alarm/config", "{\"name\":\"Alarm\",\"state_topic\":\""+DOMAIN+"/alarm\",\"command_topic\":\""+DOMAIN+"/alarm/set\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"unique_id\":\""+DOMAIN+"_alarm\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"},\"payload_available\":\"1\",\"payload_not_available\":\"0\",\"code\":\""+PINCODE+"\"}" ,qos=0,retain=True)
        self.publish("homeassistant/sensor/"+DOMAIN+"/message/config", "{\"name\":\"Message\",\"state_topic\":\""+DOMAIN+"/alarm/message\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"unique_id\":\""+DOMAIN+"_message\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"},\"payload_available\":\"1\",\"payload_not_available\":\"0\"}" ,qos=0,retain=True)
        self.publish("homeassistant/sensor/"+DOMAIN+"/timer/config", "{\"name\":\"Timer\",\"state_topic\":\""+DOMAIN+"/alarm/timer\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"unique_id\":\""+DOMAIN+"_timer\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"},\"payload_available\":\"1\",\"payload_not_available\":\"0\",\"unit_of_measurement\":\"s\"}" ,qos=0,retain=True)
        
        self.subscribe(ALARMCOMMANDTOPIC)
        for i in range(1, ALARMNUMBEROFINPUTS + 1):
            self.publish("homeassistant/binary_sensor/"+DOMAIN+"/zone_"+str(i)+"/config", "{\"name\":\"Zone "+str(i)+"\",\"platform\":\"mqtt\",\"state_topic\":\""+ALARMINPUTTOPIC % i+"\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"payload_on\":\"1\",\"payload_off\":\"0\",\"payload_available\":\"1\",\"payload_not_available\":\"0\",\"unique_id\":\""+DOMAIN+"_zone_"+str(i)+"\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"}}" ,qos=0,retain=True)
        for i in range(1, ALARMNUMBEROFOUTPUTS + 1):
            self.publish("homeassistant/switch/"+DOMAIN+"/output_"+str(i)+"/config", "{\"name\":\"Output "+str(i)+"\",\"platform\":\"mqtt\",\"state_topic\":\""+ALARMOUTPUTTOPIC % i+"\",\"command_topic\":\""+ALARMOUTPUTCOMMANDTOPIC % i+"\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"payload_on\":\"1\",\"payload_off\":\"0\",\"payload_available\":\"1\",\"payload_not_available\":\"0\",\"unique_id\":\""+DOMAIN+"_output_"+str(i)+"\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"}}" ,qos=0,retain=True)
            self.subscribe(ALARMOUTPUTCOMMANDTOPIC % i)
        for i in range(1, ALARMNUMBEROFRESPONSES + 1):
            self.publish("homeassistant/switch/"+DOMAIN+"/response_"+str(i)+"/config", "{\"name\":\"Response "+str(i)+"\",\"platform\":\"mqtt\",\"command_topic\":\""+ALARMRESPONSECOMMANDTOPIC % i+"\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"payload_on\":\"1\",\"payload_off\":\"0\",\"payload_available\":\"1\",\"payload_not_available\":\"0\",\"unique_id\":\""+DOMAIN+"_response_"+str(i)+"\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"}}" ,qos=0,retain=True)
        ...
        for i in range(1, ALARMNUMBEROFFLAGS + 1):
            self.publish("homeassistant/switch/"+DOMAIN+"/flag_"+str(i)+"/config", "{\"name\":\"Flag "+str(i)+"\",\"platform\":\"mqtt\",\"state_topic\":\""+ALARMFLAGTOPIC % i+"\",\"command_topic\":\""+ALARMFLAGCOMMANDTOPIC % i+"\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"payload_on\":\"1\",\"payload_off\":\"0\",\"payload_available\":\"1\",\"payload_not_available\":\"0\",\"unique_id\":\""+DOMAIN+"_flag_"+str(i)+"\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"}}" ,qos=0,retain=True)
            self.subscribe(ALARMFLAGCOMMANDTOPIC % i)
        for i in range(1, ALARMNUMBEROFCOUNTERS + 1):
            self.subscribe(ALARMCOUNTERCOMMANDTOPIC % i)
        self.publish("homeassistant/binary_sensor/"+DOMAIN+"/doorbell/config", "{\"name\":\"Doorbell\",\"platform\":\"mqtt\",\"state_topic\":\""+DOMAIN+"/doorbell\",\"availability_topic\":\""+DOMAIN+"/alarm/online\",\"payload_on\":\"1\",\"payload_off\":\"0\",\"payload_available\":\"1\",\"payload_not_available\":\"0\",\"unique_id\":\""+DOMAIN+"_doorbell\",\"device\": {\"identifiers\":[\""+DOMAIN+"\"], \"name\":\"Comfort Ultra\", \"manufacturer\":\"Cytech Technology\", \"model\":\"Comfort Alarm Panel\"}}" ,qos=0,retain=True)
