...
client.publish(topic= "homeassistant/sensor/envoy_grid_l1_power/config", payload= "{\"name\":\"Envoy Grid Power L1\",\"device_class\":\"power\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"kW\",\"value_template\":\"{{ float(value_json['net-consumption']['ph-a']['p'])/1000|round(2)}}\",\"icon\":\"mdi:flash\"}",qos=0,retain=True)
