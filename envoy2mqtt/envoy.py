...
client.publish(topic= "homeassistant/sensor/envoy_solar_total_power/config", payload= "{\"name\":\"Envoy Solar Power Total\",\"device_class\":\"power\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"kW\",\"value_template\":\"{%if is_state('sun.sun', 'below_horizon')%}{{0|float(0)}}{%else%}{{ (value_json['production']['ph-a']['p']|float + value_json['production']['ph-b']['p']|float + value_json['production']['ph-c']['p']|float)/1000|round(2) }}{%endif%}\",\"icon\":\"mdi:flash\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l1_voltage/config", payload= "{\"name\":\"Envoy Solar Voltage L1\",\"device_class\":\"voltage\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"V\",\"value_template\":\"{{ value_json['production']['ph-a']['v']|float|round(1)}}\",\"icon\":\"mdi:flash-triangle-outline\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l2_voltage/config", payload= "{\"name\":\"Envoy Solar Voltage L2\",\"device_class\":\"voltage\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"V\",\"value_template\":\"{{ value_json['production']['ph-b']['v']|float|round(1)}}\",\"icon\":\"mdi:flash-triangle-outline\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l3_voltage/config", payload= "{\"name\":\"Envoy Solar Voltage L3\",\"device_class\":\"voltage\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"V\",\"value_template\":\"{{ value_json['production']['ph-c']['v']|float|round(1)}}\",\"icon\":\"mdi:flash-triangle-outline\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l1_current/config", payload= "{\"name\":\"Envoy Solar Current L1\",\"device_class\":\"current\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"A\",\"value_template\":\"{{ value_json['production']['ph-a']['i']|float|round(1)}}\",\"icon\":\"mdi:flash-auto\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l2_current/config", payload= "{\"name\":\"Envoy Solar Current L2\",\"device_class\":\"current\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"A\",\"value_template\":\"{{ value_json['production']['ph-b']['i']|float|round(1)}}\",\"icon\":\"mdi:flash-auto\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l3_current/config", payload= "{\"name\":\"Envoy Solar Current L3\",\"device_class\":\"current\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"A\",\"value_template\":\"{{ value_json['production']['ph-c']['i']|float|round(1)}}\",\"icon\":\"mdi:flash-auto\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l1_frequency/config", payload= "{\"name\":\"Envoy Solar Frequency L1\",\"device_class\":\"power\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"Hz\",\"value_template\":\"{{ value_json['production']['ph-a']['f']|float|round(1)}}\",\"icon\":\"mdi:current-ac\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l2_frequency/config", payload= "{\"name\":\"Envoy Solar Frequency L2\",\"device_class\":\"power\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"Hz\",\"value_template\":\"{{ value_json['production']['ph-b']['f']|float|round(1)}}\",\"icon\":\"mdi:current-ac\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_l3_frequency/config", payload= "{\"name\":\"Envoy Solar Frequency L3\",\"device_class\":\"power\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"Hz\",\"value_template\":\"{{ value_json['production']['ph-c']['f']|float|round(1)}}\",\"icon\":\"mdi:current-ac\"}",qos=0,retain=True)
...
client.publish(topic= "homeassistant/sensor/envoy_total_power/config", payload= "{\"name\":\"Envoy Total Power\",\"device_class\":\"power\",\"platform\":\"mqtt\",\"state_class\":\"measurement\",\"state_topic\":\"/envoy/realtime.json\",\"unit_of_measurement\":\"kW\",\"value_template\":\"{{ (value_json['total-consumption']['ph-a']['p']|float + value_json['total-consumption']['ph-b']['p']|float + value_json['total-consumption']['ph-c']['p']|float)/1000|round(2) }}\",\"icon\":\"mdi:flash\"}",qos=0,retain=True)
...
client.publish(topic= "homeassistant/sensor/envoy_solar_daily_production/config", payload= "{\"name\":\"Envoy Solar Daily Production\",\"device_class\":\"energy\",\"platform\":\"mqtt\",\"state_class\":\"total_increasing\",\"state_topic\":\"/envoy/production.json\",\"unit_of_measurement\":\"kWh\",\"value_template\":\"{{ value_json['production'][1]['whToday']|float/1000|round(2)}}\",\"icon\":\"mdi:flash\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_weekly_production/config", payload= "{\"name\":\"Envoy Solar Weekly Production\",\"device_class\":\"energy\",\"platform\":\"mqtt\",\"state_class\":\"total_increasing\",\"state_topic\":\"/envoy/production.json\",\"unit_of_measurement\":\"kWh\",\"value_template\":\"{{ value_json['production'][1]['whLastSevenDays']|float/1000|round(2)}}\",\"icon\":\"mdi:flash\"}",qos=0,retain=True)
client.publish(topic= "homeassistant/sensor/envoy_solar_lifetime_production/config", payload= "{\"name\":\"Envoy Solar Lifetime Production\",\"device_class\":\"energy\",\"platform\":\"mqtt\",\"state_class\":\"total_increasing\",\"state_topic\":\"/envoy/production.json\",\"unit_of_measurement\":\"kWh\",\"value_template\":\"{{ value_json['production'][1]['whLifetime']|float/1000|round(2)}}\",\"icon\":\"mdi:flash\"}",qos=0,retain=True)
