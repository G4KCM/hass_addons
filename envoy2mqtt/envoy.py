...
client.publish(topic= "homeassistant/sensor/envoy_solar_daily_production/config", payload= "{\"name\":\"Envoy Solar Daily Production\",\"device_class\":\"energy\",\"platform\":\"mqtt\",\"state_class\":\"total_increasing\",\"state_topic\":\"/envoy/production.json\",\"unit_of_measurement\":\"kWh\",\"value_template\":\"{{ value_json['production'][1]['whToday']|float/1000|round(2)}}\",\"icon\":\"mdi:current-ac\"}",qos=0,retain=True)
